...
class Nwa_Admin {
	...
	function map_post_type() {
		...
		$labels = array(
			...
			'archives'              => __( 'Item Archives', 'nwa' ),
			'attributes'            => __( 'Item Attributes', 'nwa' ),
			'parent_item_colon'     => __( 'Parent Item:', 'nwa' ),
			'all_items'             => __( 'All Items', 'nwa' ),
			'add_new_item'          => __( 'Add New Item', 'nwa' ),
			'add_new'               => __( 'Add New', 'nwa' ),
			'new_item'              => __( 'New Item', 'nwa' ),
			'edit_item'             => __( 'Edit Item', 'nwa' ),
			'update_item'           => __( 'Update Item', 'nwa' ),
			'view_item'             => __( 'View Item', 'nwa' ),
			'view_items'            => __( 'View Items', 'nwa' ),
			'search_items'          => __( 'Search Item', 'nwa' ),
			...
			'insert_into_item'      => __( 'Insert into item', 'nwa' ),
			'uploaded_to_this_item' => __( 'Uploaded to this item', 'nwa' ),
			'items_list'            => __( 'Items list', 'nwa' ),
			'items_list_navigation' => __( 'Items list navigation', 'nwa' ),
			'filter_items_list'     => __( 'Filter items list', 'nwa' ),
		);
		$args = array(
